        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <ReasonCard number={1} title="Drive Real Change for Your Fellow Students">
              SAMAHAN negotiates with university administration, organizes large-scale campus events, manages student welfare programs, and champions advocacy campaigns that extend outside the campus. The SAMAHAN Multisectoral Council, launched to give sectoral and minority student groups an amplified voice in governance, is a direct product of student leaders who decided to build something better. If there is a problem on campus that frustrates you, a policy that feels unjust, a service that is lacking the fastest path to changing it runs through the SAMAHAN Central Board.
            </ReasonCard>
            <ReasonCard number={2} title="Develop Leadership You Cannot Learn in Class">
              The leadership skills that you learn in the student government are what employers and graduate schools look for. Being a student leader helps you develop lifelong abilities in open communication, teamwork, time management, and self-empowerment. These are not soft skills. They serve as the foundation for any successful profession.
            </ReasonCard>
            <ReasonCard number={3} title="Be the Voice Your Batchmates Need">
              Many students believe that student governments do not give enough representation. The SAMAHAN exists to promote involvement and ensure that all student voices, not just the loudest ones, influence governance. If your department or course feels unheard, the answer is not to complain louder. It is to participate and be the voice that they need.
            </ReasonCard>
            <ReasonCard number={4} title="Build Connections Across the University">
              When you work for SAMAHAN, you can connect with every course, department, and groups on campus. SAMAHAN officers represent AdDU in external conferences, collaborate with community organizations, and interact directly with university administrators. These are relationships you cannot build inside a classroom.
            </ReasonCard>
            <ReasonCard number={5} title="Leave a Legacy for Future Ateneans">
              SAMAHAN&apos;s AdvocaSIX is a six-year framework running from 2022 to 2028 which means the decisions made by today&apos;s student leaders will shape campus life for Ateneans who have not yet enrolled. The work you do in office outlives your term. Build something worth inheriting.
            </ReasonCard>
            <ReasonCard number={6} title="Student Leadership Is the First Step to National Leadership">
              There is a clear path from college government to public service in the Philippines. The values, discipline, and political instinct you develop in SAMAHAN are the same ones that drive national change. You have to start somewhere. Start here.
            </ReasonCard>
          </div>
        </div>
      </section>
